...
#SBATCH -J assembly_LSP   # job name
...
DIR=/resnick/groups/enviromics/sal/Caro_Soil_SIP/coassembly/LSP
...
megahit --k-list 25,33,55,77,99,127 -m 0.99 -t 50 -1 "$R1" -2 "$R2" -o "$OUTDIR" 
