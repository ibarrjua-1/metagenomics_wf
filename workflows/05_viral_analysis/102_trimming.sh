...
R1_FILES=($(ls /resnick/groups/enviromics/sal/Caro_Soil_SIP/single_assemblies/*_R1.fastq.gz))
...
SAMPLE_NAME=$(basename "$filename" | sed -E 's/^.*__([A-Z0-9]+_[0-9]+)__.*$/\1/')
OUTPUT="/resnick/groups/enviromics/sal/Caro_Soil_SIP/single_assemblies/$SAMPLE_NAME"
